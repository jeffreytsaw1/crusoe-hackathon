...
const probability_bitcoin_per_TH = .000001

const events = {
	"snow_storm": {"domain": "pad", "probability": .01, "multiplier": .25},
	"internet_outage": {"domain": "pad", "probability": .01, "multiplier": 0},
	"box_on_fire": {"domain": "box", "probability": .01, "multiplier": 0},
	"broken_louvers": {"domain": "box", "probability": .01, "multiplier": .75},
	"miner_disconnect": {"domain": "crypto", "probability": .01, "multiplier": .5},
	"ssh_failure": {"domain": "cloud", "probability": .01, "multiplier": .35},
	"lightbits_failure": {"domain": "cloud", "probability": .01, "multiplier": .4},
	"vm_died": {"domain": "cloud", "probability": .075, "multiplier": .25},
	"on_diesel": {"domain": "check_cloud", "probability": .05, "multiplier": 1},
	"hvac_failure": {"domain": "check_cloud", "probability": .05, "multiplier": 1}
}
...
func action_start_fix():
	...
	var crypto_fix_time = 4*pow(hashrate_capacity-hashrate,2)
